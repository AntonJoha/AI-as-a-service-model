...
def get_parser()-> ArgumentParser:
    ...
    parser.add_argument("--video_test", nargs=1, default="video_unseen.json")
...
if __name__ == "__main__":
    ...
    if args.pretrained is None:
        print("Error, you must have a pretrained model to do induction on")
        exit()
    
    m = load_model(args, args.pretrained[0]).to(device)
